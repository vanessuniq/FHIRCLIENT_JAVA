...
class L00_0_Tests {
  ...
  void L00_1_T06() {
    ...
    String ExpectedResult1 = "64432007|RADIOISOTOPE MYOCARDIAL IMAGING PROCEDURE\n";
    String ExpectedResult2 = "64432007|MYOCARDIAL IMAGING\n";
    ...
    ExpectedResult = result.contains(ExpectedResult1) ? ExpectedResult1 : ExpectedResult2;
